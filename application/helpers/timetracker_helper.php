 ...
 * http://fr.gravatar.com/site/implement/images/php/
 *
...
{
    function get_gravatar( $email, $s = 20, $d = 'mm', $r = 'g', $img = TRUE, $link =FALSE, $atts = array() ) {
        ...
        if ( $link ) { 
            $profile = 'https://secure.gravatar.com/';
            $profile .= md5( strtolower( trim( $email ) ) );
            $url='<a href="' . $profile . '">' . $url . '</a>';
        }
        return $url;
    }
}
