<?=form_open('tt/'.$user_name, array('id' => 'classicform') )?>
    ...
    <input type="text" class="span11" placeholder="activity" name="start"  id="activity" value="">
    ...
    <input type="text" class="span11" placeholder="tags" name="tags" id="tags" value="">
    ...
    <input type="text" class="span6" placeholder="value name" name="value_name" id="value_name" value="">
    =
    <label for="value">value</label>
    <input type="text" class="span5" placeholder="value" name="value" id="value" value="">
